...
namespace NITSAN\NsHeadlessBlog\Pagination;

use TYPO3\CMS\Core\Pagination\PaginationInterface;
use TYPO3\CMS\Core\Pagination\PaginatorInterface;

final class BlogPager implements PaginationInterface
{
    ...
    public function __construct(PaginatorInterface $paginator, int $maximumNumberOfLinks = 10, int $currentPage = 1)
    {
